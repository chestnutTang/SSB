...
public class Ball implements GLSurfaceView.Renderer{
    ...
    public void init() {
        ...
        for(int i2 = 0; i2 < vetex.length; ++i2) {
            vetex[i2] = (Float)vetexList.get(i2);
        }
    ...
    public void onSurfaceChanged(GL10 gl, int width, int height) {
        ...
        System.out.println("mAPositionHandler:" + this.mAPositionHandler);
        System.out.println("mUProjectMatrixHandler:" + this.mUProjectMatrixHandler);
        System.out.println("mATextureCoordHandler:" + this.mATextureCoordHandler);
        this.textrueID = OGLUtils.initTexture(this.mContext, this.mImgId);
        System.out.println("textureID:" + this.textrueID);
